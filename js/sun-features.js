...
const SUN_FEATURES = {
    ...
    layers: {
        ...
        kicker:
            "GÜNEŞ ANATOMİSİ · İÇTEN DIŞA",

        title:
            "Güneş'in Katmanları",

        lead:
            "Güneş'teki enerji çekirdekte doğar; iç bölgelerden görünür yüzeye, ardından kromosfer ve koronaya taşınır.",

        stats: [
            ["İç katmanlar", "Çekirdek · ışınım · konveksiyon"],
            ["Görünür yüzey", "Fotosfer"],
            ["Alt atmosfer", "Kromosfer"],
            ["Dış atmosfer", "Korona"]
        ],
        ...
        sections: [
            {
                title: "Çekirdek",
                text: "Merkezde hidrojenin helyuma dönüştüğü nükleer füzyon, Güneş'in ışık ve ısı enerjisini üretir."
            },
            {
                title: "Işınım bölgesi",
                text: "Enerji, plazmadaki parçacıklarla tekrar tekrar etkileşen fotonlar aracılığıyla dışarı taşınır."
            },
            {
                title: "Konveksiyon bölgesi",
                text: "Sıcak plazma yükselir, soğuyan plazma aşağı iner; enerji büyük dolaşım hareketleriyle fotosfere ulaşır."
            },
            {
                title: "Fotosfer",
                text: "Güneş'in doğrudan görebildiğimiz, görünür ışığın büyük bölümünün uzaya yayıldığı katmandır."
            },
            {
                title: "Kromosfer",
                text: "Fotosferin üzerindeki düzensiz atmosfer katmanıdır; yükseklik arttıkça sıcaklık yeniden yükselmeye başlar."
            },
            {
                title: "Korona",
                text: "Milyonlarca dereceye ulaşabilen seyrek dış atmosferdir; dışa akan maddesi Güneş rüzgârını oluşturur."
            }
        ],

        media: [
            {
                src: "/assets/media/sun/layers/sun-layers.jpg",
                alt: "Güneş'in çekirdekten koronaya katmanlarını gösteren kesit",
                caption: "Güneş'in iç bölgeleri, görünür yüzeyi ve atmosfer katmanları"
            }
        ]
...
function showFeature(
    ...
    infoContent.innerHTML = `
        ...
        ${featureId === "layers" ? "" : `
            <nav class="sun-feature-switcher" aria-label="Güneş aktivitesi">
                ${[
                    ...
                    <button
                        type="button"
                        data-sun-feature="${id}"
                        aria-current="${id === featureId ? "page" : "false"}"
                    >${label}</button>
                `).join("")}
            </nav>
        `}
