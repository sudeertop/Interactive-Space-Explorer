...
function showSaturnOverview() {
    ...
    infoContent.innerHTML = `
        ...
        <section class="info-section">
            ...
            <p>
                Halka sisteminin yapısını incelemek için model
                üzerindeki bölgelerden birini veya sağ alttaki
                seçim menüsünü kullanabilirsiniz. Seçilen halkanın
                konumu ve sınırları model üzerinde gösterilir;
                ilgili bilimsel bilgiler bu panelde açılır.
            </p>
        </section>
...
function showRingInfo(ring) {
    ...
    infoContent.parentElement.scrollTop = 0;
    ...
    infoContent.innerHTML = `
        ...
        >
            <button id="back-to-saturn" type="button">
                ← SATÜRN
            </button>
        </nav>
...
function installSaturnUIStyles() {
    ...
    style.textContent = `
        ...
        .ring-selector-button.active::after {
            opacity: 1;
            transform: scaleX(1);
        }

        .ring-selector-button:focus-visible {
...
function setSaturnComparisonInteractionLock(
    locked
) {
    ...
    if (
        ...
        if (
            ...
            comparisonState.previousRingSelectorDisplay =
                ringSelector.style.display;
...
function enterEarthComparison() {
    ...
    comparisonState.previousMinDistance =
        controls.minDistance;


    comparisonState.previousMaxDistance =
        controls.maxDistance;


    comparisonState.previousZoomSpeed =
        controls.zoomSpeed;


    comparisonState.previousRotateSpeed =
        controls.rotateSpeed;


    comparisonState.previousControlsEnabled =
        controls.enabled;


    setSaturnComparisonInteractionLock(
        true
    );
    ...
    const isNarrowComparison =
        renderer.domElement.clientWidth
        <=
        900;


    const comparisonCameraDistance =
        isNarrowComparison
            ?
            7.8
            :
...
function showEarthComparisonInfo() {
    ...
    infoContent.innerHTML = `
        ...
        <nav
            ...
            aria-label="Satürn görünümüne dön"
        >
            <button id="exit-earth-comparison" type="button">
                ← SATÜRN
            </button>
        </nav>
