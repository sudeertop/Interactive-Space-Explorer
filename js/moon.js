...
function showMoonOverview() {
    ...
    infoContent.innerHTML = `
        ...
        <section class="info-section">
            ...
            <p>
                NASA'nın
                <button
                    id="open-lro-from-panel"
                    class="inline-science-link"
                    type="button"
                >LRO</button>
                görevi, Ay yüzeyini yüksek çözünürlükte
                haritalamayı sürdürüyor.
            </p>
    ...
    document
        .getElementById("open-lro-from-panel")
        ?.addEventListener(
            "click",
            openLROInspection
        );
...
function showCraterInfo(
    ...
    infoContent.innerHTML = `
        ...
        <nav
            ...
            aria-label="Ay görünümüne dön"
        >
            <button id="back-to-moon" type="button">
                ← AY
            </button>
        </nav>
...
function showComparisonInfo() {
    ...
    infoContent.innerHTML = `
        ...
        <nav
            ...
            aria-label="Ay görünümüne dön"
        >
            <button id="exit-compare" type="button">
                ← AY
            </button>
        </nav>
