...
function showBodyInfo(
    ...
    infoContent.innerHTML = `
        ...
        >
            <button id="back-from-mars-moon" type="button">
                ← MARS
            </button>
        </nav>
...
function installMoonSelectorStyles() {

    if (
        document.getElementById(
            "mars-moon-selector-style"
        )
    ) {
        return;
    }
    ...
    style.textContent = `
        ...
        #mars-moon-selector .mars-moon-selector-title {
        ...
        #mars-moon-selector .mars-moon-selector-button {
            position: relative;
            padding: 4px 1px 7px;
            border: 0;
            border-radius: 0;
        ...
        #mars-moon-selector .mars-moon-selector-button::after {
            position: absolute;
            right: 0;
            bottom: 0;
            left: 0;
        ...
        #mars-moon-selector .mars-moon-selector-button:hover,
        #mars-moon-selector .mars-moon-selector-button[data-active="true"] {
            color: #fff;
        }

        #mars-moon-selector .mars-moon-selector-button[data-active="true"]::after {
            opacity: 1;
            transform: scaleX(1);
        }

        #mars-moon-selector .mars-moon-selector-button:focus-visible {
...
function updateMoonSelectorState() {
